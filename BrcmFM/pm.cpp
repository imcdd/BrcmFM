...
IOReturn BrcmFM::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker)
{
...
IOReturn BrcmFM::setWakeOnMagicPacket(bool active)
{
...
IOReturn BrcmFM::registerWithPolicyMaker(IOService *policyMaker)
{
    IOReturn ret;
